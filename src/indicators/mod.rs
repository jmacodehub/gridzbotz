...
/// # Example
/// ```
/// # use solana_grid_bot::indicators::calculate_sma;
...
/// # Example
/// ```
/// # use solana_grid_bot::indicators::calculate_ema;
/// let prices = vec![100.0, 101.0, 102.0, 103.0, 104.0];
...
/// # Example
/// ```
/// # use solana_grid_bot::indicators::calculate_atr_percentile;
/// let current_atr = 2.5;
/// let historical_atr = vec![1.0, 1.5, 2.0, 2.2, 2.8, 3.0];
/// let percentile = calculate_atr_percentile(current_atr, &historical_atr);
/// // percentile ≈ 0.667 (current ATR is higher than 4 of the 6 historical values)
